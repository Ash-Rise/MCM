# 2025 CUMCM A 题：烟幕干扰弹的投放策略

本目录是 2025 年全国大学生数学建模竞赛 A 题的独立冷启动项目。

当前阶段：题面读取和问题分析已完成；问题 5 的主目标已闭合为 $L_1+L_2+L_3$，最小 pilot 证明跨目标附带遮蔽真实且会改变方案排序，DP-03 仅保留 B1/B2 计分口径。尚未开始完整求解、生成正式结果、制图或写作，也未查阅公开题解、优秀论文或赛题讲评。
