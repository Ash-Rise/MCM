...
- `paper/vX.Y/`: Word paper, Pandoc Markdown source, generated GitHub preview, and conversion manifest per release.
...
# Regenerate GitHub-compatible math delimiters and HTML image widths from the
# authoritative Pandoc source, or use --check to detect a stale preview.
python src/generate_github_preview.py `
  "paper/v2.4/A题论文(v2.4).md" `
  "paper/v2.4/A题论文(v2.4)-GitHub预览.md"
python src/generate_github_preview.py `
  "paper/v2.4/A题论文(v2.4).md" `
  "paper/v2.4/A题论文(v2.4)-GitHub预览.md" --check
```
