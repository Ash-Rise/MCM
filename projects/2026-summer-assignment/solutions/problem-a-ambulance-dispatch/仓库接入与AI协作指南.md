...
协作者不必背固定口令。表达“我要改论文”“我自己改一下”“帮我开个修改分支”等意思时，AI必须读取规则、检查工作区、获取最新 `origin/main`，安全创建 `review/<协作者代号>-edit`，打开唯一正文 `.md` 并停止，不得代写或提交。

表达“修改完成”“我改好了”“检查一下”等意思时，AI只检查差异、显示效果和修改范围，输出增删报告，不提交。表达“提交论文”“提交修改”“改好了，发 PR”等明确提交意思时，该句话即授权 AI 在检查通过后 Commit、Push 并创建 PR，无需重复确认；存在冲突、验证失败或夹带文件时必须停止。AI不得自动 Merge，也不得把“提交论文”擅自解释成向竞赛平台正式交卷。
