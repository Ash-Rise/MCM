...
- 开始数学建模任务时，先读取对应项目中已有的复盘、个性化数模工作流和机器可读排版配置；适用的官方要求与用户当前决定始终优先。
...
- 论文版本目录采用 `paper/vX.Y/`。正式交付物、GitHub 在线预览和转换清单职责分离；自动生成的预览文件不得手工修改。

## 发布与验证

- 正式论文内容或 DOCX 发生变化时才更新论文版本及发行时间；生成器、在线预览、测试和模板改动记录在独立的工作流与模板更新日志中。
